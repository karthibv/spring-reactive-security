...
public class JWTAuthorizationWebFilter implements WebFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
    	System.out.println("JWTAuthorizationWebFilter >>>filter>>  "+exchange);
    ...
    private Mono<Void> authenticate(ServerWebExchange exchange,
    	...
    	System.out.println("JWTAuthorizationWebFilter >>>authenticate "+exchange);
    ...
    private Mono<Void> onAuthenticationSuccess(Authentication authentication, WebFilterExchange webFilterExchange) {
    	...
    	System.out.println("JWTAuthorizationWebFilter >>>onAuthenticationSuccess "+authentication);
